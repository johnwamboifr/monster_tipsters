    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <p className="text-gray-700 leading-6 mt-4">
            Cookies: We employ the use of cookies. By accessing our website, you
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            own the intellectual property rights for all material on Company
            Name. All intellectual property rights are reserved. You may access
            this from Company Name for your own personal use subjected to
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            <ul className="list-disc list-inside mt-2">
              <li className="text-gray-700">
                ...
                <ul className="list-disc list-inside mt-2">
                  <li className="text-gray-700">Government agencies;</li>
                  <li className="text-gray-700">Search engines;</li>
                  <li className="text-gray-700">News organizations;</li>
                  <li className="text-gray-700">
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            <ul className="list-disc list-inside mt-2">
              ...
              <li className="text-gray-700">dot.com community sites;</li>
              <li className="text-gray-700">
                associations or other groups representing charities;
              </li>
              <li className="text-gray-700">online directory distributors;</li>
              <li className="text-gray-700">internet portals;</li>
              <li className="text-gray-700">
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            that appears on your Website. You agree to protect and defend us
            against all claims that is rising on your Website. No link(s) should
            appear on any Website that may be interpreted as libelous, obscene
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            remove all links or any particular link to our Website. You approve
          ...
          <p className="text-gray-700 leading-6 mt-4">
            ...
            our website and the use of this website. Nothing in this disclaimer
            will:
            <ul className="list-disc list-inside mt-2">
              <li className="text-gray-700">
